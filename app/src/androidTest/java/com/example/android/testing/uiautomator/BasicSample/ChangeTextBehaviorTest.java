...
public class ChangeTextBehaviorTest {
    ...
    private static final String BASIC_SAMPLE_PACKAGE = "com.google.android.apps.location.gps.gnsslogger";
    ...
    public void testChangeText_sameActivity() {
        ...
        mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "register_location").depth(0)), 1000);
